...
//						                         0부터 시작 
				...
				System.out.println("score[0]의 열의 길이 : " + score[0].length);  //  {1, 2, 3, 4, 5}, = 5
				System.out.println("score[1]의 열의 길이 : " + score[1].length);  //  {6, 7, 8}, = 3
				System.out.println("score[2]의 열의 길이 : " + score[2].length);  //  {7, 6, 5, 4} = 4
