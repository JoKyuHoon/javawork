...
public class T03_treesSet {

	public static void main(String[] args) {
		Integer[] score = {100, 87, 45, 68, 95};
		...
		System.out.println("70점 초과 100점 이하인 점수 검색 : " + result5);
		
		NavigableSet<Integer> result6 = setScores.subSet(70, true, 100, false);
		System.out.println("70점 이상 100점 미만인 점수 검색 : " + result6);
