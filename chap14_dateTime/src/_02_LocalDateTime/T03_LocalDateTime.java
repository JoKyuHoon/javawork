...
public class T03_LocalDateTime {
	...
	public static void main(String[] args) {
		...
		System.out.println("종료일까지 " + today.until(endDay, ChronoUnit.MONTHS) + "개월");
		System.out.println("종료일까지 " + today.until(endDay, ChronoUnit.DAYS) + "일");
		System.out.println("종료일까지 " + today.until(endDay, ChronoUnit.HOURS) + "시간");
