...
public class T02_set_calendar {
	...
	public static void main(String[] args) {
		...
		date1.set(2025, 12-1, 15);
		System.out.println("월 : " + (date1.get(Calendar.MONTH) + 1 ));
		
		System.out.println("이달의 몇번째 주 : " + date1.get(Calendar.WEEK_OF_MONTH));
		System.out.println("올해의 몇번째 주 : " + date1.get(Calendar.WEEK_OF_MONTH));
		
		System.out.println("며칠 : " + date1.get(Calendar.DAY_OF_MONTH));
		System.out.println("365일 중 며칠 : " + date1.get(Calendar.DAY_OF_YEAR));
		...
		System.out.println(date1.get(Calendar.MILLISECOND) + "ms");
	}
