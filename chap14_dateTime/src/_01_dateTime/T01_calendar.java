...
//		java.util.Calendar.getInstance();
		...
		System.out.println("현재 년도 : " + today.get(Calendar.YEAR)); // < 상수, static 으로 되어있
		// < 월은 0(1월)부터 시작하기 때문에 +1을 해줘야한다.
		System.out.println("현재 월 : " + (today.get(Calendar.MONTH)+1)); // < 달은 0(1월)부터 시작함
...
//		↕ 같음
		...
		System.out.println("365일 중 며칠 : " + today.get(Calendar.DAY_OF_YEAR));
